...
class SystemController extends Controller
{
    ...
    public function DoSendSumaryTelegramBot(){
        $text = "Process Posting Invoice Background";
        ...
        array(
            array(
                array(
                    'text' => "\xF0\x9F\x93\x9D Process 10 in background", 'callback_data' => '/orders'
                ),
                array(
                    'text' => "\xF0\x9F\x93\x8A Success 89 in background", 'callback_data' => '/stats'
                )
            ),
            array(
                array(
                    'text' => "\xF0\x9F\x92\xB0 Waiting 2 to process", 'callback_data' => '/balance'
                ),
                array(
                    'text' => "\xF0\x9F\x93\x8B Faild 60 has failed", 'callback_data' => '/bills'
                )
            ) ,
            array(
                array(
                    'text' => "\xF0\x9F\x92\xB0 Trigger Process", 'callback_data' => '/balance'
                ),

            ),
            array(
                array(
                    'text' => "\xF0\x9F\x92\xB0 Reset Posting", 'callback_data' => '/balance'
                ),
                array(
                    'text' => "\xF0\x9F\x93\x8B Stop Process", 'callback_data' => '/bills'
                )
            ) ,
        ),
    );        
