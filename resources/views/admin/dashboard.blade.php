                    ...
                    <div class="toolbar d-flex align-items-stretch">
                        ...
                        <div
                            ...
                            <div class="d-flex align-items-stretch overflow-auto pt-3 pt-lg-0">
                                ...
                                <div class="d-flex align-items-center">
                                    <!--begin::Label-->
                                    <span class="fs-7 text-gray-700 fw-bold pe-3 d-none d-xxl-block">Quick
                                        Tools:</span>
                                    <!--end::Label-->
                                    ...
                                    <div class="d-flex">
                                        ...
                                        <div class="d-flex align-items-center">
                                            <!--begin::Menu- wrapper-->
                                            <a href="/metronic8/demo8/../demo8/apps/subscriptions/add.html"
                                                class="btn btn-sm btn-icon btn-icon-muted btn-active-icon-primary">
                                                <i class="ki-duotone ki-add-files fs-1"><span
                                        ...
                                        <div class="d-flex align-items-center">
                                            <!--begin::Menu wrapper-->
                                            <a href="/metronic8/demo8/../demo8/apps/file-manager/folders.html"
                                                class="btn btn-sm btn-icon btn-icon-muted btn-active-icon-primary">
                                                <i class="ki-duotone ki-file-up fs-1"><span
                                                        class="path1"></span><span class="path2"></span></i>
                                            </a>
                                            <!--end::Menu wrapper-->
                                        </div>
                            ...
                            <div class="row g-5 g-xl-8">
                                <div class="col-xl-4">
                                    ...
                                    <a href="#" class="card bg-body-white hoverable card-xl-stretch mb-xl-8">
                                        <!--begin::Body-->
                                        <div class="card-body">
                                            <i class="ki-duotone ki-basket text-primary fs-2x ms-n1"><span
                                                    class="path1"></span><span class="path2"></span><span
                                                    class="path3"></span><span class="path4"></span></i>
                                ...
                                <div class="col-xl-4">
                                    ...
                                    <a href="#" class="card bg-primary hoverable card-xl-stretch mb-xl-8">
                                        <!--begin::Body-->
                                        <div class="card-body">
                                            <i class="ki-duotone ki-element-11 text-white fs-2x ms-n1"><span
                                                    class="path1"></span><span class="path2"></span><span
                                                    class="path3"></span><span class="path4"></span></i>
                                ...
                                <div class="col-xl-4">
                                    ...
                                    <!--begin::Statistics Widget 5-->
                                    <a href="#"
                                        class="card bg-gray-900 hoverable card-xl-stretch mb-5 mb-xl-8">
                                        <!--begin::Body-->
                                        <div class="card-body">
                                            <i class="ki-duotone ki-chart-simple text-gray-100 fs-2x ms-n1"><span
                                                    class="path1"></span><span class="path2"></span><span
                                                    class="path3"></span><span class="path4"></span></i>
                                        ...
                                        <div class="card-header border-0 pt-5">
                                            ...
                                            <div class="card-toolbar">
                                                ...
                                                <div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px"
                                                    data-kt-menu="true" id="kt_menu_654c7b51ddcd3">
                                                    <!--begin::Header-->
                                                    <div class="px-7 py-5">
                                                        ...
                                                        <div class="mb-10">
                                                            ...
                                                            <div>
                                                                <select class="form-select form-select-solid" multiple
                                                                    ...
                                                                    data-dropdown-parent="#kt_menu_654c7b51ddcd3"
                                    ...
                                    <div class="card card-xl-stretch mb-5 mb-xl-8">
                                        ...
                                        <div class="card-header border-0 pt-5">
                                            ...
                                            <div class="card-toolbar">
                                                ...
                                                <!--begin::Menu 1-->
                                                <div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px"
                                                    data-kt-menu="true" id="kt_menu_654c7b51ddead">
                                                    <!--begin::Header-->
                                                    <div class="px-7 py-5">
                                                        <div class="fs-5 text-gray-900 fw-bold">Filter Options</div>
                                                    </div>
                                                        ...
                                                        <div class="mb-10">
                                                            ...
                                                            <div>
                                                                <select class="form-select form-select-solid" multiple
                                                                    ...
                                                                    data-close-on-select="false"
                                                                    data-placeholder="Select option"
                                                                    data-dropdown-parent="#kt_menu_654c7b51ddead"
                                                                    data-allow-clear="true">
                                                                    <option></option>
                                                                    <option value="1">Approved</option>
                                                                    <option value="2">Pending</option>
                                    ...
                                    <div class="card card-xl-stretch mb-xl-8">
                                        ...
                                        <div class="card-header align-items-center border-0 mt-4">
                                            ...
                                            <div class="card-toolbar">
                                                ...
                                                <!--begin::Menu 1-->
                                                <div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px"
                                                    data-kt-menu="true" id="kt_menu_654c7b51ddf09">
                                                    <!--begin::Header-->
                                                    <div class="px-7 py-5">
                                                        <div class="fs-5 text-gray-900 fw-bold">Filter Options</div>
                                                    </div>
                                                        ...
                                                        <div class="mb-10">
                                                            ...
                                                            <div>
                                                                <select class="form-select form-select-solid" multiple
                                                                    ...
                                                                    data-close-on-select="false"
                                                                    data-placeholder="Select option"
                                                                    data-dropdown-parent="#kt_menu_654c7b51ddf09"
                                                                    data-allow-clear="true">
                                                                    <option></option>
                                                                    <option value="1">Approved</option>
                                                                    <option value="2">Pending</option>
                                        ...
                                        <div class="card-body pt-3">
                                            ...
                                            <div class="d-flex align-items-sm-center mb-7">
                                                ...
                                                <div class="symbol symbol-60px symbol-2by3 me-4">
                                                    <div class="symbol-label"
                                                        style="background-image: url('/metronic8/demo8/assets/media/stock/600x400/img-20.jpg')">
                                                    </div>
                                                </div>
                                                <!--end::Symbol-->
                                            ...
                                            <div class="d-flex align-items-sm-center mb-7">
                                                ...
                                                <div class="symbol symbol-60px symbol-2by3 me-4">
                                                    <div class="symbol-label"
                                                        style="background-image: url('/metronic8/demo8/assets/media/stock/600x400/img-19.jpg')">
                                                    </div>
                                                </div>
                                                <!--end::Symbol-->
                                            ...
                                            <div class="d-flex align-items-sm-center mb-7">
                                                ...
                                                <div class="symbol symbol-60px symbol-2by3 me-4">
                                                    <div class="symbol-label"
                                                        style="background-image: url('/metronic8/demo8/assets/media/stock/600x400/img-25.jpg')">
                                                    </div>
                                                </div>
                                                <!--end::Symbol-->
                                            ...
                                            <div class="d-flex align-items-sm-center ">
                                                ...
                                                <div class="symbol symbol-60px symbol-2by3 me-4">
                                                    <div class="symbol-label"
                                                        style="background-image: url('/metronic8/demo8/assets/media/stock/600x400/img-24.jpg')">
                                                    </div>
                                                </div>
                                                <!--end::Symbol-->
                                    ...
                                    <div class="card card-xl-stretch mb-5 mb-xl-8">
                                        ...
                                        <div class="card-body pt-0">
                                            ...
                                            <div class="d-flex align-items-center bg-light-success rounded p-5 mb-7">
                                                <i class="ki-duotone ki-abstract-26 text-success fs-1 me-5"><span
                                                        class="path1"></span><span class="path2"></span></i>
                                                <!--begin::Title-->
                                                <div class="flex-grow-1 me-2">
                                                    <a href="#"
                                            ...
                                            <div class="d-flex align-items-center bg-light-danger rounded p-5 mb-7">
                                                <i class="ki-duotone ki-abstract-26 text-danger fs-1 me-5"><span
                                                        class="path1"></span><span class="path2"></span></i>
                                                <!--begin::Title-->
                                                <div class="flex-grow-1 me-2">
                                                    <a href="#"
                                            ...
                                            <div class="d-flex align-items-center bg-light-info rounded p-5 ">
                                                <i class="ki-duotone ki-abstract-26 text-info fs-1 me-5"><span
                                                        class="path1"></span><span class="path2"></span></i>
                                                <!--begin::Title-->
                                                <div class="flex-grow-1 me-2">
                                                    <a href="#"
    ...
    <div id="kt_activities" class="bg-body" data-kt-drawer="true" data-kt-drawer-name="activities"
        ...
        <div class="card shadow-none border-0 rounded-0">
                            ...
                            <div class="timeline-content mb-10 mt-n1">
                                ...
                                <div class="pe-3 mb-5">
                                    ...
                                    <div class="d-flex align-items-center mt-1 fs-6">
                                        ...
                                        <div class="symbol symbol-circle symbol-25px" data-bs-toggle="tooltip"
                                            ...
                                            <img src="/metronic8/demo8/assets/media/avatars/300-14.jpg"
                                                alt="img" />
                                        </div>
                                        <!--end::User-->
                                    </div>
                                ...
                                <div class="overflow-auto pb-5">
                                    ...
                                    <div
                                        ...
                                        <!--begin::Title-->
                                        <a href="/metronic8/demo8/../demo8/apps/projects/project.html"
                                        ...
                                        <div
                                            ...
                                            <div class="symbol symbol-circle symbol-25px">
                                                <img src="/metronic8/demo8/assets/media/avatars/300-2.jpg"
                                                    alt="img" />
                                            </div>
                                            <!--end::User-->
                                    ...
                                    <div
                                        ...
                                        <div class="symbol-group symbol-hover flex-nowrap flex-grow-1 min-w-100px">
                                            <!--begin::User-->
                                            <div class="symbol symbol-circle symbol-25px">
                                                <img src="/metronic8/demo8/assets/media/avatars/300-20.jpg"
                                                    alt="img" />
                                            </div>
                                            <!--end::User-->
                                ...
                                <div class="overflow-auto pe-3">
                                    ...
                                    <div class="d-flex align-items-center mt-1 fs-6">
                                        ...
                                        <div class="symbol symbol-circle symbol-25px" data-bs-toggle="tooltip"
                                            ...
                                            <img src="/metronic8/demo8/assets/media/avatars/300-1.jpg"
                                                alt="img" />
                                        </div>
                                        <!--end::User-->
                                    </div>
                                ...
                                <div class="mb-5 pe-3">
                                    ...
                                    <div class="d-flex align-items-center mt-1 fs-6">
                                        ...
                                        <div class="symbol symbol-circle symbol-25px" data-bs-toggle="tooltip"
                                            ...
                                            <img src="/metronic8/demo8/assets/media/avatars/300-23.jpg"
                                                alt="img" />
                                        </div>
                                        <!--end::User-->
                                    </div>
                                    ...
                                    <div
                                        ...
                                        <div class="d-flex flex-aligns-center pe-10 pe-lg-20">
                                            ...
                                            <img alt="" class="w-30px me-3"
                                                src="/metronic8/demo8/assets/media/svg/files/pdf.svg" />
                                            <!--end::Icon-->
                                        ...
                                        <div class="d-flex flex-aligns-center pe-10 pe-lg-20">
                                            <!--begin::Icon-->
                                            <img alt="/metronic8/demo8/../demo8/apps/projects/project.html"
                                                class="w-30px me-3"
                                                src="/metronic8/demo8/assets/media/svg/files/doc.svg" />
                                            <!--end::Icon-->
                                        ...
                                        <div class="d-flex flex-aligns-center">
                                            ...
                                            <img alt="/metronic8/demo8/../demo8/apps/projects/project.html"
                                                class="w-30px me-3"
                                                src="/metronic8/demo8/assets/media/svg/files/css.svg" />
                                            <!--end::Icon-->
                                ...
                                <div class="overflow-auto pb-5">
                                    <div
                                        ...
                                        <div class="overlay me-10">
                                            ...
                                            <div class="overlay-wrapper">
                                                <img alt="img" class="rounded w-150px"
                                                    src="/metronic8/demo8/assets/media/stock/600x400/img-29.jpg" />
                                            </div>
                                            <!--end::Image-->
                                        ...
                                        <div class="overlay me-10">
                                            ...
                                            <div class="overlay-wrapper">
                                                <img alt="img" class="rounded w-150px"
                                                    src="/metronic8/demo8/assets/media/stock/600x400/img-31.jpg" />
                                            </div>
                                            <!--end::Image-->
                                        ...
                                        <div class="overlay">
                                            ...
                                            <div class="overlay-wrapper">
                                                <img alt="img" class="rounded w-150px"
                                                    src="/metronic8/demo8/assets/media/stock/600x400/img-40.jpg" />
                                            </div>
                                            <!--end::Image-->
                                ...
                                <div class="pe-3 mb-5">
                                    ...
                                    <div class="d-flex align-items-center mt-1 fs-6">
                                        ...
                                        <div class="symbol symbol-circle symbol-25px" data-bs-toggle="tooltip"
                                            ...
                                            <img src="/metronic8/demo8/assets/media/avatars/300-4.jpg"
                                                alt="img" />
                                        </div>
                                        <!--end::User-->
                                    </div>
            ...
            <div class="card-footer py-5 text-center" id="kt_activities_footer">
                <a href="/metronic8/demo8/../demo8/pages/user-profile/activity.html"
                        ...
                        <div class="d-flex flex-column align-items-start">
                            ...
                            <div class="d-flex align-items-center mb-2">
                                ...
                                <div class="symbol  symbol-35px symbol-circle "><img alt="Pic"
                                        src="/metronic8/demo8/assets/media/avatars/300-25.jpg" /></div>
                                <!--end::Avatar-->
                                <!--begin::Details-->
                                <div class="ms-3">
                                    <a href="#"
                    ...
                    <div class="d-flex justify-content-end mb-10 ">
                        ...
                        <div class="d-flex flex-column align-items-end">
                            ...
                            <div class="d-flex align-items-center mb-2">
                                ...
                                <!--begin::Avatar-->
                                <div class="symbol  symbol-35px symbol-circle "><img alt="Pic"
                                        src="/metronic8/demo8/assets/media/avatars/300-1.jpg" /></div>
                                <!--end::Avatar-->
                            </div>
                            <!--end::User-->
            ...
            <div class="card-body hover-scroll-overlay-y h-400px pt-5">
                ...
                <div class="d-flex flex-stack">
                    ...
                    <div class="d-flex flex-column me-3">
                        <!--begin::Section-->
                        <div class="mb-3">
                            <a href="/metronic8/demo8/../demo8/apps/ecommerce/sales/details.html"
                    ...
                    <div class="symbol symbol-70px symbol-2by3 flex-shrink-0">
                        <img src="/metronic8/demo8/assets/media/stock/600x400/img-1.jpg" alt="" />
                    </div>
                    <!--end::Pic-->
                </div>
                <!--end::Item-->
                ...
                <div class="d-flex flex-stack">
                    ...
                    <!--begin::Pic-->
                    <div class="symbol symbol-70px symbol-2by3 flex-shrink-0">
                        <img src="/metronic8/demo8/assets/media/stock/600x400/img-3.jpg" alt="" />
                    </div>
                    <!--end::Pic-->
                </div>
                <!--end::Item-->
                ...
                <div class="d-flex flex-stack">
                    ...
                    <!--begin::Pic-->
                    <div class="symbol symbol-70px symbol-2by3 flex-shrink-0">
                        <img src="/metronic8/demo8/assets/media/stock/600x400/img-8.jpg" alt="" />
                    </div>
                    <!--end::Pic-->
                </div>
                <!--end::Item-->
                ...
                <div class="d-flex flex-stack">
                    ...
                    <!--begin::Pic-->
                    <div class="symbol symbol-70px symbol-2by3 flex-shrink-0">
                        <img src="/metronic8/demo8/assets/media/stock/600x400/img-26.jpg" alt="" />
                    </div>
                    <!--end::Pic-->
                </div>
                <!--end::Item-->
                ...
                <div class="d-flex flex-stack">
                    ...
                    <!--begin::Pic-->
                    <div class="symbol symbol-70px symbol-2by3 flex-shrink-0">
                        <img src="/metronic8/demo8/assets/media/stock/600x400/img-21.jpg" alt="" />
                    </div>
                    <!--end::Pic-->
                </div>
                <!--end::Item-->
                ...
                <div class="d-flex flex-stack">
                    ...
                    <!--begin::Pic-->
                    <div class="symbol symbol-70px symbol-2by3 flex-shrink-0">
                        <img src="/metronic8/demo8/assets/media/stock/600x400/img-34.jpg" alt="" />
                    </div>
                    <!--end::Pic-->
                </div>
                <!--end::Item-->
                ...
                <div class="d-flex flex-stack">
                    ...
                    <!--begin::Pic-->
                    <div class="symbol symbol-70px symbol-2by3 flex-shrink-0">
                        <img src="/metronic8/demo8/assets/media/stock/600x400/img-27.jpg" alt="" />
                    </div>
                    <!--end::Pic-->
                </div>
                <!--end::Item-->
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo1/index.html"
                                                    ...
                                                    <span
                                                        ...
                                                        <img src="/metronic8/demo8/assets/media/preview/demos/placeholder.jpg"
                                    ...
                                    <div class="hover-scroll-y pe-12 me-n12" data-kt-scroll="true"
                                        ...
                                        <div class="row gy-10">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <!--begin::Preview-->
                                                <a href="/metronic8/demo8/../demo8/index.html" data-kt-href="true"
                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    <!--begin::Title-->
                                                    <h3
                                                        class="ps-12 pt-9 mb-7 text-gray-900 fw-bold letter-spacing fs-4">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <!--begin::Preview-->
                                                <a href="/metronic8/demo8/../demo8/dashboards/marketing.html"
                                                    data-kt-href="true"
                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    <!--begin::Title-->
                                                    <h3
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <!--begin::Preview-->
                                                <a href="/metronic8/demo8/../demo8/dashboards/social.html"
                                                    data-kt-href="true"
                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    <!--begin::Title-->
                                                    <h3
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <!--begin::Preview-->
                                                <a href="/metronic8/demo8/../demo8/dashboards/ecommerce.html"
                                                    data-kt-href="true"
                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    <!--begin::Title-->
                                                    <h3
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <!--begin::Preview-->
                                                <a href="/metronic8/demo8/../demo8/dashboards/store-analytics.html"
                                                    data-kt-href="true"
                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    <!--begin::Title-->
                                                    <h3
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <!--begin::Preview-->
                                                <a href="/metronic8/demo8/../demo8/dashboards/logistics.html"
                                                    data-kt-href="true"
                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    <!--begin::Title-->
                                                    <h3
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <!--begin::Preview-->
                                                <a href="/metronic8/demo8/../demo8/dashboards/delivery.html"
                                                    data-kt-href="true"
                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    <!--begin::Title-->
                                                    <h3
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <!--begin::Preview-->
                                                <a href="/metronic8/demo8/../demo8/dashboards/online-courses.html"
                                                    data-kt-href="true"
                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    <!--begin::Title-->
                                                    <h3
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <!--begin::Preview-->
                                                <a href="/metronic8/demo8/../demo8/dashboards/school.html"
                                                    data-kt-href="true"
                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    <!--begin::Title-->
                                                    <h3
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <!--begin::Preview-->
                                                <a href="/metronic8/demo8/../demo8/dashboards/crypto.html"
                                                    data-kt-href="true"
                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    <!--begin::Title-->
                                                    <h3
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <!--begin::Preview-->
                                                <a href="/metronic8/demo8/../demo8/dashboards/finance-performance.html"
                                                    data-kt-href="true"
                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    <!--begin::Title-->
                                                    <h3
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <!--begin::Preview-->
                                                <a href="/metronic8/demo8/../demo8/dashboards/website-analytics.html"
                                                    data-kt-href="true"
                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    <!--begin::Title-->
                                                    <h3
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <!--begin::Preview-->
                                                <a href="/metronic8/demo8/../demo8/dashboards/bidding.html"
                                                    data-kt-href="true"
                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    <!--begin::Title-->
                                                    <h3
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <!--begin::Preview-->
                                                <a href="/metronic8/demo8/../demo8/dashboards/podcast.html"
                                                    data-kt-href="true"
                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    <!--begin::Title-->
                                                    <h3
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <!--begin::Preview-->
                                                <a href="/metronic8/demo8/../demo8/dashboards/projects.html"
                                                    data-kt-href="true"
                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    <!--begin::Title-->
                                                    <h3
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <!--begin::Preview-->
                                                <a href="/metronic8/demo8/../demo8/dashboards/call-center.html"
                                                    data-kt-href="true"
                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    <!--begin::Title-->
                                                    <h3
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <!--begin::Preview-->
                                                <a href="/metronic8/demo8/../demo8/dashboards/pos.html"
                                                    data-kt-href="true"
                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    <!--begin::Title-->
                                                    <h3
                                    ...
                                    <div class="hover-scroll-y pe-12 me-n12" data-kt-scroll="true"
                                        ...
                                        <div class="row gy-10">
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <!--begin::Preview-->
                                                <a href="/metronic8/demo8/../demo8/apps/projects/list.html"
                                                    data-kt-href="true"
                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    <!--begin::Title-->
                                                    <h3
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <!--begin::Preview-->
                                                <a href="/metronic8/demo8/../demo8/apps/customers/list.html"
                                                    data-kt-href="true"
                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    <!--begin::Title-->
                                                    <h3
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <!--begin::Preview-->
                                                <a href="/metronic8/demo8/../demo8/apps/subscriptions/list.html"
                                                    data-kt-href="true"
                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    <!--begin::Title-->
                                                    <h3
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <!--begin::Preview-->
                                                <a href="/metronic8/demo8/../demo8/apps/user-management/users/list.html"
                                                    data-kt-href="true"
                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    <!--begin::Title-->
                                                    <h3
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <!--begin::Preview-->
                                                <a href="/metronic8/demo8/../demo8/apps/invoices/create.html"
                                                    data-kt-href="true"
                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    <!--begin::Title-->
                                                    <h3
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <!--begin::Preview-->
                                                <a href="/metronic8/demo8/../demo8/apps/support-center/overview.html"
                                                    data-kt-href="true"
                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    <!--begin::Title-->
                                                    <h3
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <!--begin::Preview-->
                                                <a href="/metronic8/demo8/../demo8/apps/chat/private.html"
                                                    data-kt-href="true"
                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    <!--begin::Title-->
                                                    <h3
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <!--begin::Preview-->
                                                <a href="/metronic8/demo8/../demo8/apps/calendar.html"
                                                    data-kt-href="true"
                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    <!--begin::Title-->
                                                    <h3
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <!--begin::Preview-->
                                                <a href="/metronic8/demo8/../demo8/apps/inbox/listing.html"
                                                    data-kt-href="true"
                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    <!--begin::Title-->
                                                    <h3
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <!--begin::Preview-->
                                                <a href="/metronic8/demo8/../demo8/apps/contacts/getting-started.html"
                                                    data-kt-href="true"
                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    <!--begin::Title-->
                                                    <h3
                                            ...
                                            <div class="tab-pane fade show active"
                                                ...
                                                <div class="row g-10">
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="/metronic8/demo8/../demo8/authentication/layouts/corporate/sign-in.html"
                                                            data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="/metronic8/demo8/../demo8/authentication/layouts/creative/sign-in.html"
                                                            data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="/metronic8/demo8/../demo8/authentication/layouts/fancy/sign-in.html"
                                                            data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="/metronic8/demo8/../demo8/authentication/layouts/overlay/sign-in.html"
                                                            data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="/metronic8/demo8/../demo8/authentication/extended/multi-steps-sign-up.html"
                                                            data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="/metronic8/demo8/../demo8/authentication/layouts/corporate/two-factor.html"
                                                            data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="/metronic8/demo8/../demo8/authentication/general/password-confirmation.html"
                                                            data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="/metronic8/demo8/../demo8/authentication/general/verify-email.html"
                                                            data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="/metronic8/demo8/../demo8/authentication/general/welcome.html"
                                                            data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="/metronic8/demo8/../demo8/authentication/general/coming-soon.html"
                                                            data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="/metronic8/demo8/../demo8/authentication/general/account-deactivated.html"
                                                            data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="/metronic8/demo8/../demo8/authentication/general/error-404.html"
                                                            data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="/metronic8/demo8/../demo8/authentication/general/error-500.html"
                                                            data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                    ...
                                                    <div class="show"
                                                        ...
                                                        <div class="row g-10 pt-2 pb-5">
                                                            ...
                                                            <div class="col-lg-4">
                                                                ...
                                                                <!--begin::Preview-->
                                                                <a href="/metronic8/demo8/../demo8/pages/user-profile/overview.html"
                                                                    data-kt-href="true"
                                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                                    <!--begin::Title-->
                                                                    <h3
                                                            ...
                                                            <div class="col-lg-4">
                                                                ...
                                                                <!--begin::Preview-->
                                                                <a href="/metronic8/demo8/../demo8/pages/user-profile/projects.html"
                                                                    data-kt-href="true"
                                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                                    <!--begin::Title-->
                                                                    <h3
                                                            ...
                                                            <div class="col-lg-4">
                                                                ...
                                                                <!--begin::Preview-->
                                                                <a href="/metronic8/demo8/../demo8/pages/user-profile/campaigns.html"
                                                                    data-kt-href="true"
                                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                                    <!--begin::Title-->
                                                                    <h3
                                                            ...
                                                            <div class="col-lg-4">
                                                                ...
                                                                <!--begin::Preview-->
                                                                <a href="/metronic8/demo8/../demo8/pages/user-profile/documents.html"
                                                                    data-kt-href="true"
                                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                                    <!--begin::Title-->
                                                                    <h3
                                                            ...
                                                            <div class="col-lg-4">
                                                                ...
                                                                <!--begin::Preview-->
                                                                <a href="/metronic8/demo8/../demo8/pages/user-profile/followers.html"
                                                                    data-kt-href="true"
                                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                                    <!--begin::Title-->
                                                                    <h3
                                                    ...
                                                    <div class="collapse"
                                                        ...
                                                        <div class="row g-10 pt-2 pb-5">
                                                            ...
                                                            <div class="col-lg-4">
                                                                ...
                                                                <!--begin::Preview-->
                                                                <a href="/metronic8/demo8/../demo8/pages/about.html"
                                                                    data-kt-href="true"
                                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                                    <!--begin::Title-->
                                                                    <h3
                                                            ...
                                                            <div class="col-lg-4">
                                                                ...
                                                                <!--begin::Preview-->
                                                                <a href="/metronic8/demo8/../demo8/pages/contact.html"
                                                                    data-kt-href="true"
                                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                                    <!--begin::Title-->
                                                                    <h3
                                                            ...
                                                            <div class="col-lg-4">
                                                                ...
                                                                <!--begin::Preview-->
                                                                <a href="/metronic8/demo8/../demo8/pages/licenses.html"
                                                                    data-kt-href="true"
                                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                                    <!--begin::Title-->
                                                                    <h3
                                                            ...
                                                            <div class="col-lg-4">
                                                                ...
                                                                <!--begin::Preview-->
                                                                <a href="/metronic8/demo8/../demo8/pages/team.html"
                                                                    data-kt-href="true"
                                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                                    <!--begin::Title-->
                                                                    <h3
                                                            ...
                                                            <div class="col-lg-4">
                                                                ...
                                                                <!--begin::Preview-->
                                                                <a href="/metronic8/demo8/../demo8/pages/sitemap.html"
                                                                    data-kt-href="true"
                                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                                    <!--begin::Title-->
                                                                    <h3
                                                    ...
                                                    <div class="collapse"
                                                        ...
                                                        <div class="row g-10 pt-2 pb-5">
                                                            ...
                                                            <div class="col-lg-4">
                                                                ...
                                                                <!--begin::Preview-->
                                                                <a href="/metronic8/demo8/../demo8/pages/social/feeds.html"
                                                                    data-kt-href="true"
                                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                                    <!--begin::Title-->
                                                                    <h3
                                                            ...
                                                            <div class="col-lg-4">
                                                                ...
                                                                <!--begin::Preview-->
                                                                <a href="/metronic8/demo8/../demo8/pages/social/activity.html"
                                                                    data-kt-href="true"
                                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                                    <!--begin::Title-->
                                                                    <h3
                                                            ...
                                                            <div class="col-lg-4">
                                                                ...
                                                                <!--begin::Preview-->
                                                                <a href="/metronic8/demo8/../demo8/pages/social/followers.html"
                                                                    data-kt-href="true"
                                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                                    <!--begin::Title-->
                                                                    <h3
                                                            ...
                                                            <div class="col-lg-4">
                                                                ...
                                                                <!--begin::Preview-->
                                                                <a href="/metronic8/demo8/../demo8/pages/social/settings.html"
                                                                    data-kt-href="true"
                                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                                    <!--begin::Title-->
                                                                    <h3
                                                    ...
                                                    <div class="collapse"
                                                        ...
                                                        <div class="row g-10 pt-2 pb-5">
                                                            ...
                                                            <div class="col-lg-4">
                                                                ...
                                                                <!--begin::Preview-->
                                                                <a href="/metronic8/demo8/../demo8/pages/faq/classic.html"
                                                                    data-kt-href="true"
                                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                                    <!--begin::Title-->
                                                                    <h3
                                                            ...
                                                            <div class="col-lg-4">
                                                                ...
                                                                <!--begin::Preview-->
                                                                <a href="/metronic8/demo8/../demo8/pages/faq/extended.html"
                                                                    data-kt-href="true"
                                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                                    <!--begin::Title-->
                                                                    <h3
                                                            ...
                                                            <div class="col-lg-4">
                                                                ...
                                                                <!--begin::Preview-->
                                                                <a href="/metronic8/demo8/../demo8/pages/blog/home.html"
                                                                    data-kt-href="true"
                                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                                    <!--begin::Title-->
                                                                    <h3
                                                            ...
                                                            <div class="col-lg-4">
                                                                ...
                                                                <!--begin::Preview-->
                                                                <a href="/metronic8/demo8/../demo8/pages/blog/post.html"
                                                                    data-kt-href="true"
                                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                                    <!--begin::Title-->
                                                                    <h3
                                            ...
                                            <div class="tab-pane fade "
                                                ...
                                                <div class="row g-10">
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="/metronic8/demo8/../demo8/account/overview.html"
                                                            data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="/metronic8/demo8/../demo8/account/settings.html"
                                                            data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="/metronic8/demo8/../demo8/account/billing.html"
                                                            data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="/metronic8/demo8/../demo8/account/security.html"
                                                            data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="/metronic8/demo8/../demo8/account/referrals.html"
                                                            data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="/metronic8/demo8/../demo8/account/logs.html"
                                                            data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="/metronic8/demo8/../demo8/account/api-keys.html"
                                                            data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="/metronic8/demo8/../demo8/account/statements.html"
                                                            data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                            ...
                                            <div class="tab-pane fade "
                                                ...
                                                <div class="row g-10">
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="/metronic8/demo8/../demo8/utilities/modals/general/view-users.html"
                                                            data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="/metronic8/demo8/../demo8/utilities/modals/general/upgrade-plan.html"
                                                            data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="/metronic8/demo8/../demo8/utilities/modals/wizards/top-up-wallet.html"
                                                            data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="/metronic8/demo8/../demo8/utilities/modals/general/share-earn.html"
                                                            data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="/metronic8/demo8/../demo8/utilities/modals/general/select-users.html"
                                                            data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="/metronic8/demo8/../demo8/utilities/modals/forms/bidding.html"
                                                            data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="/metronic8/demo8/../demo8/utilities/modals/wizards/offer-a-deal.html"
                                                            data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="/metronic8/demo8/../demo8/utilities/modals/forms/new-target.html"
                                                            data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="/metronic8/demo8/../demo8/utilities/modals/forms/new-card.html"
                                                            data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="/metronic8/demo8/../demo8/utilities/modals/forms/new-address.html"
                                                            data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="/metronic8/demo8/../demo8/utilities/modals/general/invite-friends.html"
                                                            data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="/metronic8/demo8/../demo8/utilities/modals/wizards/create-project.html"
                                                            data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="/metronic8/demo8/../demo8/utilities/modals/wizards/create-campaign.html"
                                                            data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="/metronic8/demo8/../demo8/utilities/modals/wizards/create-account.html"
                                                            data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="/metronic8/demo8/../demo8/utilities/modals/wizards/create-app.html"
                                                            data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="/metronic8/demo8/../demo8/utilities/modals/forms/create-api-key.html"
                                                            data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="/metronic8/demo8/../demo8/utilities/modals/wizards/two-factor-authentication.html"
                                                            data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                            ...
                                            <div class="tab-pane fade "
                                                ...
                                                <div class="row g-10">
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="/metronic8/demo8/../demo8/utilities/wizards/horizontal.html"
                                                            data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="/metronic8/demo8/../demo8/utilities/wizards/vertical.html"
                                                            data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                            ...
                                            <div class="tab-pane fade "
                                                ...
                                                <div class="row g-10">
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="/metronic8/demo8/../demo8/utilities/search/users.html"
                                                            data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="/metronic8/demo8/../demo8/utilities/search/horizontal.html"
                                                            data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="/metronic8/demo8/../demo8/utilities/search/vertical.html"
                                                            data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="/metronic8/demo8/../demo8/utilities/search/select-location.html"
                                                            data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                            ...
                                            <div class="tab-pane fade "
                                                ...
                                                <div class="row g-10">
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="/metronic8/demo8/../demo8/widgets/charts.html"
                                                            data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="/metronic8/demo8/../demo8/widgets/feeds.html"
                                                            data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="/metronic8/demo8/../demo8/widgets/lists.html"
                                                            data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="/metronic8/demo8/../demo8/widgets/mixed.html"
                                                            data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="/metronic8/demo8/../demo8/widgets/statistics.html"
                                                            data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="/metronic8/demo8/../demo8/widgets/tables.html"
                                                            data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                            ...
                                            <div class="tab-pane fade "
                                                ...
                                                <div class="row g-10">
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="/metronic8/demo8/../demo8/authentication/email/welcome-message.html"
                                                            data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="/metronic8/demo8/../demo8/authentication/email/subscription-confirmed.html"
                                                            data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="/metronic8/demo8/../demo8/authentication/email/reset-password.html"
                                                            data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="/metronic8/demo8/../demo8/authentication/email/card-declined.html"
                                                            data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="/metronic8/demo8/../demo8/authentication/email/promo-1.html"
                                                            data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="/metronic8/demo8/../demo8/authentication/email/promo-2.html"
                                                            data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="/metronic8/demo8/../demo8/authentication/email/promo-3.html"
                                                            data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <div class="d-flex flex-column gap-3 gap-lg-5">
                                                ...
                                                <a class="fw-6 fw-semibold"
                                                    href="/metronic8/demo8/../demo8/index.html">
                                                    Dashboard </a>
                                                ...
                                                <a class="fw-6 fw-semibold"
                                                    href="/metronic8/demo8/../demo8/dashboards/marketing.html">
                                                ...
                                                <a class="fw-6 fw-semibold"
                                                    href="/metronic8/demo8/../demo8/dashboards/social.html">
                                                    Social Dashboard </a>
                                                ...
                                                <a class="fw-6 fw-semibold"
                                                    href="/metronic8/demo8/../demo8/dashboards/ecommerce.html">
                                                ...
                                                <a class="fw-6 fw-semibold"
                                                    href="/metronic8/demo8/../demo8/dashboards/store-analytics.html">
                                                    Store Analytics </a>
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <div class="d-flex flex-column gap-3 gap-lg-5">
                                                ...
                                                <a class="fw-6 fw-semibold"
                                                    href="/metronic8/demo8/../demo8/dashboards/logistics.html">
                                                    Logistics </a>
                                                ...
                                                <a class="fw-6 fw-semibold"
                                                    href="/metronic8/demo8/../demo8/dashboards/delivery.html">
                                                    Delivery </a>
                                                ...
                                                <a class="fw-6 fw-semibold"
                                                    href="/metronic8/demo8/../demo8/dashboards/online-courses.html">
                                                    Online Courses </a>
                                                ...
                                                <a class="fw-6 fw-semibold"
                                                    href="/metronic8/demo8/../demo8/dashboards/school.html">
                                                    Hello Tyler </a>
                                                ...
                                                <a class="fw-6 fw-semibold"
                                                    href="/metronic8/demo8/../demo8/dashboards/crypto.html">
                                                    My Balance: 37,045$ </a>
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <div class="d-flex flex-column gap-3 gap-lg-5">
                                                ...
                                                <a class="fw-6 fw-semibold"
                                                    href="/metronic8/demo8/../demo8/dashboards/finance-performance.html">
                                                ...
                                                <a class="fw-6 fw-semibold"
                                                    href="/metronic8/demo8/../demo8/dashboards/website-analytics.html">
                                                    Website Analytics </a>
                                                ...
                                                <a class="fw-6 fw-semibold"
                                                    href="/metronic8/demo8/../demo8/dashboards/bidding.html">
                                                    Bidding Dashboard </a>
                                                ...
                                                <a class="fw-6 fw-semibold"
                                                    href="/metronic8/demo8/../demo8/dashboards/podcast.html">
                                                    Podcast Dashboard </a>
                                                ...
                                                <a class="fw-6 fw-semibold"
                                                    href="/metronic8/demo8/../demo8/dashboards/projects.html">
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <div class="d-flex flex-column gap-3 gap-lg-5">
                                                ...
                                                <a class="fw-6 fw-semibold"
                                                    href="/metronic8/demo8/../demo8/dashboards/call-center.html">
                                                    Call Center </a>
                                                ...
                                                <a class="fw-6 fw-semibold"
                                                    href="/metronic8/demo8/../demo8/dashboards/pos.html">
                                                    POS System </a>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <div class="d-flex flex-column gap-3 gap-lg-5">
                                                ...
                                                <a class="fw-6 fw-semibold"
                                                    href="/metronic8/demo8/../demo8/authentication/layouts/corporate/sign-in.html">
                                                    Corporate </a>



                                                <a class="fw-6 fw-semibold"
                                                    href="/metronic8/demo8/../demo8/authentication/layouts/creative/sign-in.html">
                                                    Creative </a>



                                                <a class="fw-6 fw-semibold"
                                                    href="/metronic8/demo8/../demo8/authentication/layouts/fancy/sign-in.html">
                                                    Fancy </a>



                                                <a class="fw-6 fw-semibold"
                                                    href="/metronic8/demo8/../demo8/authentication/layouts/overlay/sign-in.html">
                                                    Overlay </a>
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <div class="d-flex flex-column gap-3 gap-lg-5">
                                                ...
                                                <a class="fw-6 fw-semibold"
                                                    href="/metronic8/demo8/../demo8/authentication/extended/multi-steps-sign-up.html">
                                                    Multi-Step </a>



                                                <a class="fw-6 fw-semibold"
                                                    href="/metronic8/demo8/../demo8/authentication/layouts/corporate/two-factor.html">
                                                    Two-Factor </a>



                                                <a class="fw-6 fw-semibold"
                                                    href="/metronic8/demo8/../demo8/authentication/general/password-confirmation.html">
                                                    Password Changed </a>



                                                <a class="fw-6 fw-semibold"
                                                    href="/metronic8/demo8/../demo8/authentication/general/verify-email.html">
                                                    Verify Email </a>
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <div class="d-flex flex-column gap-3 gap-lg-5">
                                                ...
                                                <a class="fw-6 fw-semibold"
                                                    href="/metronic8/demo8/../demo8/authentication/general/welcome.html">
                                                    Welcome </a>



                                                <a class="fw-6 fw-semibold"
                                                    href="/metronic8/demo8/../demo8/authentication/general/coming-soon.html">
                                                    Coming Soon </a>



                                                <a class="fw-6 fw-semibold"
                                                    href="/metronic8/demo8/../demo8/authentication/general/account-deactivated.html">
                                                    Account Deactivated </a>



                                                <a class="fw-6 fw-semibold"
                                                    href="/metronic8/demo8/../demo8/authentication/general/error-404.html">
                                                    404 Page </a>
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <div class="d-flex flex-column gap-3 gap-lg-5">
                                                ...
                                                <a class="fw-6 fw-semibold"
                                                    href="/metronic8/demo8/../demo8/authentication/general/error-500.html">
                                                    505 Page </a>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <div class="d-flex flex-column gap-3 gap-lg-5">
                                                ...
                                                <a class="fw-6 fw-semibold"
                                                    href="/metronic8/demo8/../demo8/account/overview.html">
                                                    Overview </a>



                                                <a class="fw-6 fw-semibold"
                                                    href="/metronic8/demo8/../demo8/account/settings.html">
                                                    Settings </a>



                                                <a class="fw-6 fw-semibold"
                                                    href="/metronic8/demo8/../demo8/account/billing.html">
                                                    Billing </a>
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <div class="d-flex flex-column gap-3 gap-lg-5">
                                                ...
                                                <a class="fw-6 fw-semibold"
                                                    href="/metronic8/demo8/../demo8/account/security.html">
                                                    Security </a>



                                                <a class="fw-6 fw-semibold"
                                                    href="/metronic8/demo8/../demo8/account/referrals.html">
                                                    Referrals </a>



                                                <a class="fw-6 fw-semibold"
                                                    href="/metronic8/demo8/../demo8/account/logs.html">
                                                    Logs </a>
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <div class="d-flex flex-column gap-3 gap-lg-5">
                                                ...
                                                <a class="fw-6 fw-semibold"
                                                    href="/metronic8/demo8/../demo8/account/api-keys.html">
                                                    API Keys </a>



                                                <a class="fw-6 fw-semibold"
                                                    href="/metronic8/demo8/../demo8/account/statements.html">
                                                    Statements </a>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <div class="d-flex flex-column gap-3 gap-lg-5">
                                                ...
                                                <a class="fw-6 fw-semibold"
                                                    href="/metronic8/demo8/../demo8/utilities/modals/general/view-users.html">
                                                    View Friends </a>



                                                <a class="fw-6 fw-semibold"
                                                    href="/metronic8/demo8/../demo8/utilities/modals/general/upgrade-plan.html">
                                                    Upgrade Plan </a>



                                                <a class="fw-6 fw-semibold"
                                                    href="/metronic8/demo8/../demo8/utilities/modals/wizards/top-up-wallet.html">
                                                    Topup Wallet </a>



                                                <a class="fw-6 fw-semibold"
                                                    href="/metronic8/demo8/../demo8/utilities/modals/general/share-earn.html">
                                                    Share & Earn </a>



                                                <a class="fw-6 fw-semibold"
                                                    href="/metronic8/demo8/../demo8/utilities/modals/general/select-users.html">
                                                    Select User </a>
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <div class="d-flex flex-column gap-3 gap-lg-5">
                                                ...
                                                <a class="fw-6 fw-semibold"
                                                    href="/metronic8/demo8/../demo8/utilities/modals/forms/bidding.html">
                                                    Place Bid </a>



                                                <a class="fw-6 fw-semibold"
                                                    href="/metronic8/demo8/../demo8/utilities/modals/wizards/offer-a-deal.html">
                                                    Offer Deal </a>



                                                <a class="fw-6 fw-semibold"
                                                    href="/metronic8/demo8/../demo8/utilities/modals/forms/new-target.html">
                                                    New Target </a>



                                                <a class="fw-6 fw-semibold"
                                                    href="/metronic8/demo8/../demo8/utilities/modals/forms/new-card.html">
                                                    New Card </a>



                                                <a class="fw-6 fw-semibold"
                                                    href="/metronic8/demo8/../demo8/utilities/modals/forms/new-address.html">
                                                    New Address </a>
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <div class="d-flex flex-column gap-3 gap-lg-5">
                                                ...
                                                <a class="fw-6 fw-semibold"
                                                    href="/metronic8/demo8/../demo8/utilities/modals/general/invite-friends.html">
                                                    Invite Friend </a>



                                                <a class="fw-6 fw-semibold"
                                                    href="/metronic8/demo8/../demo8/utilities/modals/wizards/create-project.html">
                                                    Create Project </a>



                                                <a class="fw-6 fw-semibold"
                                                    href="/metronic8/demo8/../demo8/utilities/modals/wizards/create-campaign.html">
                                                    Create Campaign </a>



                                                <a class="fw-6 fw-semibold"
                                                    href="/metronic8/demo8/../demo8/utilities/modals/wizards/create-account.html">
                                                    Create Business Account </a>



                                                <a class="fw-6 fw-semibold"
                                                    href="/metronic8/demo8/../demo8/utilities/modals/wizards/create-app.html">
                                                    Create App </a>
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <div class="d-flex flex-column gap-3 gap-lg-5">
                                                ...
                                                <a class="fw-6 fw-semibold"
                                                    href="/metronic8/demo8/../demo8/utilities/modals/forms/create-api-key.html">
                                                    Create Api Key </a>



                                                <a class="fw-6 fw-semibold"
                                                    href="/metronic8/demo8/../demo8/utilities/modals/wizards/two-factor-authentication.html">
                                                    2 Factor Auth </a>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <div class="d-flex flex-column gap-3 gap-lg-5">
                                                ...
                                                <a class="fw-6 fw-semibold"
                                                    href="/metronic8/demo8/../demo8/utilities/wizards/horizontal.html">
                                                    2 Factor Auth </a>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <div class="d-flex flex-column gap-3 gap-lg-5">
                                                ...
                                                <a class="fw-6 fw-semibold"
                                                    href="/metronic8/demo8/../demo8/utilities/search/users.html">
                                                    Search Users </a>
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <div class="d-flex flex-column gap-3 gap-lg-5">
                                                ...
                                                <a class="fw-6 fw-semibold"
                                                    href="/metronic8/demo8/../demo8/utilities/search/horizontal.html">
                                                    Search Horizontal </a>
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <div class="d-flex flex-column gap-3 gap-lg-5">
                                                ...
                                                <a class="fw-6 fw-semibold"
                                                    href="/metronic8/demo8/../demo8/utilities/search/vertical.html">
                                                    Search Vertical </a>
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <div class="d-flex flex-column gap-3 gap-lg-5">
                                                ...
                                                <a class="fw-6 fw-semibold"
                                                    href="/metronic8/demo8/../demo8/utilities/search/select-location.html">
                                                    Search Location </a>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <div class="d-flex flex-column gap-3 gap-lg-5">
                                                ...
                                                <a class="fw-6 fw-semibold"
                                                    href="/metronic8/demo8/../demo8/widgets/charts.html">
                                                    Charts </a>



                                                <a class="fw-6 fw-semibold"
                                                    href="/metronic8/demo8/../demo8/widgets/feeds.html">
                                                    Feeds </a>
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <div class="d-flex flex-column gap-3 gap-lg-5">
                                                ...
                                                <a class="fw-6 fw-semibold"
                                                    href="/metronic8/demo8/../demo8/widgets/lists.html">
                                                    Lists </a>



                                                <a class="fw-6 fw-semibold"
                                                    href="/metronic8/demo8/../demo8/widgets/mixed.html">
                                                    Mixed </a>
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <div class="d-flex flex-column gap-3 gap-lg-5">
                                                ...
                                                <a class="fw-6 fw-semibold"
                                                    href="/metronic8/demo8/../demo8/widgets/statistics.html">
                                                    Statistics </a>



                                                <a class="fw-6 fw-semibold"
                                                    href="/metronic8/demo8/../demo8/widgets/tables.html">
                                                    Tables </a>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <div class="d-flex flex-column gap-3 gap-lg-5">
                                                ...
                                                <a class="fw-6 fw-semibold"
                                                    href="/metronic8/demo8/../demo8/authentication/email/welcome-message.html">
                                                    Welcome </a>



                                                <a class="fw-6 fw-semibold"
                                                    href="/metronic8/demo8/../demo8/authentication/email/subscription-confirmed.html">
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <div class="d-flex flex-column gap-3 gap-lg-5">
                                                ...
                                                <a class="fw-6 fw-semibold"
                                                    href="/metronic8/demo8/../demo8/authentication/email/reset-password.html">
                                                    Reset Password </a>



                                                <a class="fw-6 fw-semibold"
                                                    href="/metronic8/demo8/../demo8/authentication/email/card-declined.html">
                                                    Card Declined </a>
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <div class="d-flex flex-column gap-3 gap-lg-5">
                                                ...
                                                <a class="fw-6 fw-semibold"
                                                    href="/metronic8/demo8/../demo8/authentication/email/promo-1.html">
                                                    Promotion 1 </a>



                                                <a class="fw-6 fw-semibold"
                                                    href="/metronic8/demo8/../demo8/authentication/email/promo-2.html">
                                                    Promotion 2 </a>
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <div class="d-flex flex-column gap-3 gap-lg-5">
                                                ...
                                                <a class="fw-6 fw-semibold"
                                                    href="/metronic8/demo8/../demo8/authentication/email/promo-3.html">
                                                    Promotion 3 </a>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <div class="d-flex flex-column gap-3 gap-lg-5">
                                                ...
                                                <a class="fw-6 fw-semibold"
                                                    href="/metronic8/demo8/../demo8/pages/user-profile/overview.html">
                                                    Profile Overview </a>



                                                <a class="fw-6 fw-semibold"
                                                    href="/metronic8/demo8/../demo8/pages/user-profile/projects.html">
                                                    User Projects </a>
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <div class="d-flex flex-column gap-3 gap-lg-5">
                                                ...
                                                <a class="fw-6 fw-semibold"
                                                    href="/metronic8/demo8/../demo8/pages/user-profile/campaigns.html">
                                                    User Campaigns </a>



                                                <a class="fw-6 fw-semibold"
                                                    href="/metronic8/demo8/../demo8/pages/user-profile/documents.html">
                                                    User Documents </a>
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <div class="d-flex flex-column gap-3 gap-lg-5">
                                                ...
                                                <a class="fw-6 fw-semibold"
                                                    href="/metronic8/demo8/../demo8/pages/user-profile/followers.html">
                                                    User Followers </a>



                                                <a class="fw-6 fw-semibold"
                                                    href="/metronic8/demo8/../demo8/pages/user-profile/activity.html">
                                                    User Activity </a>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <div class="d-flex flex-column gap-3 gap-lg-5">
                                                ...
                                                <a class="fw-6 fw-semibold"
                                                    href="/metronic8/demo8/../demo8/pages/about.html">
                                                    About Us </a>



                                                <a class="fw-6 fw-semibold"
                                                    href="/metronic8/demo8/../demo8/pages/contact.html">
                                                    Contact Us </a>
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <div class="d-flex flex-column gap-3 gap-lg-5">
                                                ...
                                                <a class="fw-6 fw-semibold"
                                                    href="/metronic8/demo8/../demo8/pages/licenses.html">
                                                    License </a>



                                                <a class="fw-6 fw-semibold"
                                                    href="/metronic8/demo8/../demo8/pages/team.html">
                                                    Our Team </a>
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <div class="d-flex flex-column gap-3 gap-lg-5">
                                                ...
                                                <a class="fw-6 fw-semibold"
                                                    href="/metronic8/demo8/../demo8/pages/sitemap.html">
                                                    Sitemap </a>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <div class="d-flex flex-column gap-3 gap-lg-5">
                                                ...
                                                <a class="fw-6 fw-semibold"
                                                    href="/metronic8/demo8/../demo8/pages/social/feeds.html">
                                                    Activity </a>
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <div class="d-flex flex-column gap-3 gap-lg-5">
                                                ...
                                                <a class="fw-6 fw-semibold"
                                                    href="/metronic8/demo8/../demo8/pages/social/activity.html">
                                                    Feeds </a>
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <div class="d-flex flex-column gap-3 gap-lg-5">
                                                ...
                                                <a class="fw-6 fw-semibold"
                                                    href="/metronic8/demo8/../demo8/pages/social/followers.html">
                                                    Followers </a>
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <div class="d-flex flex-column gap-3 gap-lg-5">
                                                ...
                                                <a class="fw-6 fw-semibold"
                                                    href="/metronic8/demo8/../demo8/pages/social/settings.html">
                                                    Settings </a>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <div class="d-flex flex-column gap-3 gap-lg-5">
                                                ...
                                                <a class="fw-6 fw-semibold"
                                                    href="/metronic8/demo8/../demo8/pages/faq/classic.html">
                                                    FAQ Classic </a>
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <div class="d-flex flex-column gap-3 gap-lg-5">
                                                ...
                                                <a class="fw-6 fw-semibold"
                                                    href="/metronic8/demo8/../demo8/pages/faq/extended.html">
                                                    FAQ Extended </a>
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <div class="d-flex flex-column gap-3 gap-lg-5">
                                                ...
                                                <a class="fw-6 fw-semibold"
                                                    href="/metronic8/demo8/../demo8/pages/blog/home.html">
                                                    Blog Home </a>
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <div class="d-flex flex-column gap-3 gap-lg-5">
                                                ...
                                                <a class="fw-6 fw-semibold"
                                                    href="/metronic8/demo8/../demo8/pages/blog/post.html">
                                                    Blog Post </a>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <div class="d-flex flex-column gap-3 gap-lg-5">
                                                ...
                                                <a class="fw-6 fw-semibold"
                                                    href="/metronic8/demo8/../demo8/apps/projects/list.html">
                                                    Projects </a>



                                                <a class="fw-6 fw-semibold"
                                                    href="/metronic8/demo8/../demo8/apps/ecommerce/catalog/products.html">
                                                    Ecommerce </a>



                                                <a class="fw-6 fw-semibold"
                                                    href="/metronic8/demo8/../demo8/apps/customers/list.html">
                                                    Customers </a>
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <div class="d-flex flex-column gap-3 gap-lg-5">
                                                ...
                                                <a class="fw-6 fw-semibold"
                                                    href="/metronic8/demo8/../demo8/apps/subscriptions/list.html">
                                                    Subscriptions </a>



                                                <a class="fw-6 fw-semibold"
                                                    href="/metronic8/demo8/../demo8/apps/user-management/users/list.html">
                                                    User Management </a>



                                                <a class="fw-6 fw-semibold"
                                                    href="/metronic8/demo8/../demo8/apps/invoices/create.html">
                                                    Invoices </a>
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <div class="d-flex flex-column gap-3 gap-lg-5">
                                                ...
                                                <a class="fw-6 fw-semibold"
                                                    href="/metronic8/demo8/../demo8/apps/support-center/overview.html">
                                                    Support Center </a>



                                                <a class="fw-6 fw-semibold"
                                                    href="/metronic8/demo8/../demo8/apps/chat/private.html">
                                                    Chat </a>
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <div class="d-flex flex-column gap-3 gap-lg-5">
                                                ...
                                                <a class="fw-6 fw-semibold"
                                                    href="/metronic8/demo8/../demo8/apps/file-manager/folders.html">
                                                    File Manager </a>



                                                <a class="fw-6 fw-semibold"
                                                    href="/metronic8/demo8/../demo8/apps/inbox/listing.html">
                                                    Inbox </a>



                                                <a class="fw-6 fw-semibold"
                                                    href="/metronic8/demo8/../demo8/apps/contacts/getting-started.html">
                                                    Contacts </a>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body scroll-y mx-5 mx-xl-18 pt-0 pb-15">
                    ...
                    <div class="btn btn-light-primary fw-bold w-100 mb-8">
                        <img alt="Logo" src="/metronic8/demo8/assets/media/svg/brand-logos/google-icon.svg"
                            class="h-20px me-3" />
                        ...
                        <div class="mh-300px scroll-y me-n7 pe-7">
                            ...
                            <div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="symbol symbol-35px symbol-circle">
                                        <img alt="Pic" src="/metronic8/demo8/assets/media/avatars/300-6.jpg" />
                                    </div>
                                    <!--end::Avatar-->
                            ...
                            <div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
                                ...
                                <div class="d-flex align-items-center">
                                    <!--begin::Avatar-->
                                    <div class="symbol symbol-35px symbol-circle">
                                        <img alt="Pic" src="/metronic8/demo8/assets/media/avatars/300-1.jpg" />
                                    </div>
                                    <!--end::Avatar-->
                            ...
                            <div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
                                ...
                                <div class="d-flex align-items-center">
                                    <!--begin::Avatar-->
                                    <div class="symbol symbol-35px symbol-circle">
                                        <img alt="Pic" src="/metronic8/demo8/assets/media/avatars/300-5.jpg" />
                                    </div>
                                    <!--end::Avatar-->
                            ...
                            <div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="symbol symbol-35px symbol-circle">
                                        <img alt="Pic"
                                            src="/metronic8/demo8/assets/media/avatars/300-25.jpg" />
                                    </div>
                                    <!--end::Avatar-->
                            ...
                            <div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
                                ...
                                <div class="d-flex align-items-center">
                                    <!--begin::Avatar-->
                                    <div class="symbol symbol-35px symbol-circle">
                                        <img alt="Pic" src="/metronic8/demo8/assets/media/avatars/300-9.jpg" />
                                    </div>
                                    <!--end::Avatar-->
                            ...
                            <div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="symbol symbol-35px symbol-circle">
                                        <img alt="Pic"
                                            src="/metronic8/demo8/assets/media/avatars/300-23.jpg" />
                                    </div>
                                    <!--end::Avatar-->
                            ...
                            <div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="symbol symbol-35px symbol-circle">
                                        <img alt="Pic"
                                            src="/metronic8/demo8/assets/media/avatars/300-12.jpg" />
                                    </div>
                                    <!--end::Avatar-->
                            ...
                            <div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="symbol symbol-35px symbol-circle">
                                        <img alt="Pic"
                                            src="/metronic8/demo8/assets/media/avatars/300-13.jpg" />
                                    </div>
                                    <!--end::Avatar-->
                            ...
                            <div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="symbol symbol-35px symbol-circle">
                                        <img alt="Pic"
                                            src="/metronic8/demo8/assets/media/avatars/300-21.jpg" />
                                    </div>
                                    <!--end::Avatar-->
                        ...
                        <div class="py-5">
                                ...
                                <div class="mh-375px scroll-y me-n7 pe-7">
                                    ...
                                    <a href="#"
                                        ...
                                        <div class="symbol symbol-35px symbol-circle me-5">
                                            <img alt="Pic"
                                                src="/metronic8/demo8/assets/media/avatars/300-6.jpg" />
                                        </div>
                                        <!--end::Avatar-->
                                    ...
                                    <a href="#"
                                        ...
                                        <div class="symbol symbol-35px symbol-circle me-5">
                                            <img alt="Pic"
                                                src="/metronic8/demo8/assets/media/avatars/300-1.jpg" />
                                        </div>
                                        <!--end::Avatar-->
                                    ...
                                    <a href="#"
                                        ...
                                        <div class="symbol symbol-35px symbol-circle me-5">
                                            <img alt="Pic"
                                                src="/metronic8/demo8/assets/media/avatars/300-5.jpg" />
                                        </div>
                                        <!--end::Avatar-->
                                ...
                                <div class="mh-375px scroll-y me-n7 pe-7">
                                    ...
                                    <div class="rounded d-flex flex-stack bg-active-lighten p-4" data-user-id="6">
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="symbol symbol-35px symbol-circle">
                                                <img alt="Pic"
                                                    src="/metronic8/demo8/assets/media/avatars/300-9.jpg" />
                                            </div>
                                            <!--end::Avatar-->
                            ...
                            <div data-kt-search-element="empty" class="text-center d-none">
                                ...
                                <div class="text-center px-5">
                                    <img src="/metronic8/demo8/assets/media/illustrations/sketchy-1/1.png"
